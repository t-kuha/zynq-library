...
void AddDescriptors();
void InitDefaultsNodeProtoImpl();
void InitDefaultsNodeProto();
void InitDefaultsTreeProtoImpl();
void InitDefaultsTreeProto();
void InitDefaultsHierarchyProtoImpl();
void InitDefaultsHierarchyProto();
void InitDefaultsPathProtoImpl();
void InitDefaultsPathProto();
void InitDefaultsPathNodeProtoImpl();
void InitDefaultsPathNodeProto();
...
extern HierarchyProtoDefaultTypeInternal _HierarchyProto_default_instance_;
class NodeProto;
...
extern PathNodeProtoDefaultTypeInternal _PathNodeProto_default_instance_;
class PathProto;
...
extern TreeProtoDefaultTypeInternal _TreeProto_default_instance_;
}  // namespace caffe2
namespace caffe2 { const ::std::string& GetEmptyStringAlreadyInited(); 
