...
extern DBReaderProtoDefaultTypeInternal _DBReaderProto_default_instance_;
class DeviceOption;
...
extern ExecutionStepDefaultTypeInternal _ExecutionStep_default_instance_;
class NetDef;
...
extern PlanDefDefaultTypeInternal _PlanDef_default_instance_;
class QTensorProto;
class QTensorProtoDefaultTypeInternal;
extern QTensorProtoDefaultTypeInternal _QTensorProto_default_instance_;
class TensorProto;
...
extern TensorShapesDefaultTypeInternal _TensorShapes_default_instance_;
}  // namespace caffe2
namespace caffe2 { const ::std::string& GetEmptyStringAlreadyInited(); 
...
class DeviceOption : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe2.DeviceOption) */ {
 public:
  ...
  bool has_hip_gpu_id() const;
  void clear_hip_gpu_id();
  static const int kHipGpuIdFieldNumber = 7;
  ::google::protobuf::int32 hip_gpu_id() const;
  void set_hip_gpu_id(::google::protobuf::int32 value);
 ...
 private:
  ...
  void set_has_hip_gpu_id();
  void clear_has_hip_gpu_id();
  ...
  ::google::protobuf::int32 hip_gpu_id_;
...
// optional int32 hip_gpu_id = 7;
inline bool DeviceOption::has_hip_gpu_id() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void DeviceOption::set_has_hip_gpu_id() {
  _has_bits_[0] |= 0x00000010u;
}
inline void DeviceOption::clear_has_hip_gpu_id() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void DeviceOption::clear_hip_gpu_id() {
  hip_gpu_id_ = 0;
  clear_has_hip_gpu_id();
}
inline ::google::protobuf::int32 DeviceOption::hip_gpu_id() const {
  // @@protoc_insertion_point(field_get:caffe2.DeviceOption.hip_gpu_id)
  return hip_gpu_id_;
}
inline void DeviceOption::set_hip_gpu_id(::google::protobuf::int32 value) {
  set_has_hip_gpu_id();
  hip_gpu_id_ = value;
  // @@protoc_insertion_point(field_set:caffe2.DeviceOption.hip_gpu_id)
}
