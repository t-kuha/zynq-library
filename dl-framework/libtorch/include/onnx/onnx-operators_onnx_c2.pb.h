...
#ifndef PROTOBUF_INCLUDED_onnx_2fonnx_2doperators_5fonnx_5fc2_2eproto
#define PROTOBUF_INCLUDED_onnx_2fonnx_2doperators_5fonnx_5fc2_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_onnx_2fonnx_2doperators_5fonnx_5fc2_2eproto ONNX_API
...
namespace google {
namespace protobuf {
template<> ONNX_API ::onnx_c2::FunctionProto* Arena::CreateMaybeMessage<::onnx_c2::FunctionProto>(Arena*);
template<> ONNX_API ::onnx_c2::OperatorProto* Arena::CreateMaybeMessage<::onnx_c2::OperatorProto>(Arena*);
template<> ONNX_API ::onnx_c2::OperatorSetProto* Arena::CreateMaybeMessage<::onnx_c2::OperatorSetProto>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace onnx_c2 {
...
class ONNX_API FunctionProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:onnx_c2.FunctionProto) */ {
 public:
  FunctionProto();
...
class ONNX_API OperatorProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:onnx_c2.OperatorProto) */ {
 public:
  OperatorProto();
...
class ONNX_API OperatorSetProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:onnx_c2.OperatorSetProto) */ {
 public:
  OperatorSetProto();
...
template <> struct is_proto_enum< ::onnx_c2::OperatorStatus> : ::std::true_type {};
template <>
...
#endif  // PROTOBUF_INCLUDED_onnx_2fonnx_2doperators_5fonnx_5fc2_2eproto
