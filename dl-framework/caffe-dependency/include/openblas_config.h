...
#define OPENBLAS_ARMV7 
#define OPENBLAS_L1_DATA_SIZE 65536
...
#define OPENBLAS_HAVE_VFPV3 
#define OPENBLAS_HAVE_VFP 
#define OPENBLAS_CORE_ARMV7 
#define OPENBLAS_CHAR_CORENAME "ARMV7"
#define OPENBLAS_GEMM_MULTITHREAD_THRESHOLD 4
#define OPENBLAS_VERSION " OpenBLAS 0.3.0.dev "
